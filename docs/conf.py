...
# Specify this to get other static HTML included in sphinx docs
html_extra_path = [
    "pages/"
]
...
latex_documents = [
    (master_doc, 'polydoc.tex', 'polydoc Documentation',
     'James Lamb', 'manual'),
]
...
man_pages = [
    (master_doc, 'polydoc', 'polydoc Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'polydoc', 'polydoc Documentation',
     author, 'polydoc', 'One line description of project.',
     'Miscellaneous'),
]
